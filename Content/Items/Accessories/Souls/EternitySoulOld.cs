...
namespace yitangFargo.Content.Items.Accessories.Souls
{
    ...
    public class EternitySoulOld : FlightMasteryWings
    {
        ...
        public override void SafeModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            string description = Language.GetTextValue("Mods.yitangFargo.EternitySoulOldExtra.ESCommonTips");

            if (Main.GameUpdateCount % 12 == 0 || EternitySoulSystem.TooltipLines == null)
            {
            ...
            tooltips.Add(new TooltipLine(Mod, "HonorText", Language.GetTextValue("Mods.yitangFargo.EternitySoulOldExtra.Honor")));
        }
		...
		//	player.AddEffect<UniverseSpeedOldEffect>(Item);
		...
		//	ColossusSoulOld.AddEffects(player, Item, 0, 0.4f, 15);
		//	SupersonicSoulOld.AddEffects(player, Item, hideVisual);
		//	FlightMasterySoulOld.AddEffects(player, Item);
		//	TrawlerSoulOld.AddEffects(player, Item, hideVisual);
		//	WorldShaperSoulOld.AddEffects(player, Item, hideVisual);

		//	//泰拉之魂
		//	ModContent.GetInstance<TerrariaSoulOld>().UpdateAccessory(player, hideVisual);
		//	//大师之魂
		//	ModContent.GetInstance<MasochistSoulOld>().UpdateAccessory(player, hideVisual);
		//	//暴君之魂
		...
		//	{
		//		CreateRecipe()
		//			.AddIngredient<UniverseSoulOld>()
		//			.AddIngredient<DimensionSoulOld>()
		//			.AddIngredient<TerrariaSoulOld>()
		//			.AddIngredient<MasochistSoulOld>()
		...
		public class EternitySoulSystem : ModSystem
        {
            ...
            {
                string text = Language.GetTextValue("Mods.yitangFargo.EternitySoulOldExtra.AllLines");
