...
{
    public class UniverseSoulOld : BaseSoul, ILocalizedModType
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
			...
			//各项数据加成
			fargoPlayer.UniverseSoul = true;
			fargoPlayer.UniverseCore = true;
            ...
            //调用盗贼的职业魂效果
            ModContent.GetInstance<VagabondsSoulOld>().UpdateAccessory(player, hideVisual);
        }
        ...
        public override void AddRecipes()
        {
            CreateRecipe()
                ...
                .AddIngredient<BerserkerSoulOld>()
                .AddIngredient<SnipersSoulOld>()
                .AddIngredient<ArchWizardsSoulOld>()
                .AddIngredient<ConjuristsSoulOld>()
                .AddIngredient<VagabondsSoulOld>()
	...
	public class UniverseSpeedOldEffect : AccessoryEffect
	{
